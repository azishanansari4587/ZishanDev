...
export function GlowingEffectDemoSecond() {
  return (
    <ul
      className="max-w-2xl grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-2 gap-4">
    <GridItem
    ...
    <GridItem
        ...
        content={`<ul class="list-disc pl-4"> <li>API Integration & Server-Side Logic</li><li>Docker</li><li>Vercel, Hostinger Deployment</li><li>CI/CD Pipelines</li></ul>`}
    />
    <GridItem
        icon={<IconGitMerge className="h-4 w-4 text-black dark:text-neutral-400" />}
        title="Version Control & Tools"
        content={`<ul class="list-disc pl-4"> <li>Git, GitHub</li><li>Jira, Slack</li><li>Agile & Scrum Methodologies</li><li>Zustand, Redux (State Management)</li></ul>`}
    />
    <GridItem
        icon={<IconWindmill className="h-4 w-4 text-black dark:text-neutral-400" />}
        title="Other Technical Skills"
        content={`<ul class="list-disc pl-4"> <li>Problem Solving & Debugging</li><li>Performance Optimization</li><li>Web Security Best Practices</li><li>System Design (Basic Understanding)</li></ul>`}
    /> 
    </ul>
  );
}
